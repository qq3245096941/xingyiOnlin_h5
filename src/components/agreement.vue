<template>
  <van-popup v-model="isPopShow" position="bottom" @close="close" round closeable>
    <div class="box">
      ...
      <div class="body">
        <p>尊敬的芯艺在线平台用户;芯艺在线法务部门友情提示:本平台是一个在线艺术品交易平台,提醒广大客户理性消费,禁止使用信用卡网货等信用额度进行消费,在有一定消费实力的前提下合理合法的进行消费,平台禁止刷单,代抢单,代投资。合作抢拍,代付款等行为。</p>
        <p>用户盲目的听信和参与以上行为造成的个人财产损失的, 需自行承担责任。</p>
      </div>
